...
<header class="fd-header">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between fd-header-row">
            ...
            <!-- Search -->
            <div class="fd-header-search d-none d-lg-flex">
                <jdoc:include type="modules" name="search" style="raw" />
                <?php if (!$app->getMenu()->getActive() || true) : ?>
                <form class="fd-search-form" action="<?php echo JRoute::_('index.php?option=com_search'); ?>" method="get">
                    <input type="text" name="searchword" class="fd-search-input" placeholder="<?php echo JText::_('TPL_SEARCH_PLACEHOLDER'); ?>" value="Search files...">
...
<div class="fd-main container">
    <div class="row fd-main-row">
        ...
        <aside class="col-lg-3 fd-sidebar">
            ...
            <div class="fd-card">
                <h3 class="fd-card-heading">Top Downloads</h3>
        ...
        <div class="col-lg-9 fd-content">
            ...
            <div class="fd-hero">
                <div class="fd-hero-text">
                    ...
                    <p>Find the latest software, apps, documents, games, and more.</p>
                    <form class="fd-hero-search" action="<?php echo JRoute::_('index.php?option=com_search'); ?>" method="get">
                        <input type="text" name="searchword" placeholder="Search files...">
                        <button type="submit" class="btn fd-btn-primary">Search</button>
                    </form>
                </div>
    ...
    <div class="container">
        <div class="row fd-footer-row">
            <div class="col-lg-3 col-md-6 fd-footer-col">
                ...
                <div class="fd-social">
                    <jdoc:include type="modules" name="footer-links" style="fd_social" />
                </div>
            </div>

            <div class="col-lg-3 col-md-6 fd-footer-col">
                <h4>Quick Links</h4>
                <jdoc:include type="modules" name="footer-links" style="fd_footerlist" />
            </div>
            ...
            <div class="col-lg-3 col-md-6 fd-footer-col">
                <h4>Support</h4>
                <jdoc:include type="modules" name="footer-support" style="fd_footerlist" />
            </div>
        </div>
