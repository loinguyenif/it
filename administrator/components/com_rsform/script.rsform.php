...
.red {
	...
	<div class="rsform-column-10">
		...
		<?php } ?>
		<h2>Changelog v3.1.4</h2>
		<ul class="version-history">
			<li><span class="version-new">New</span> Emails can be deferred until submission is confirmed through the 'Defer Emails Until Confirmation' option.</li>
            <li><span class="version-upgraded">Upg</span> 'Confirmation Link' when editing a submission in the backend, to manually confirm a submission and trigger deferred emails.</li>
            <li><span class="version-upgraded">Upg</span> Placed all submission confirmation options inside their own group under Form Properties - Form Info - Confirmation.</li>
		</ul>
