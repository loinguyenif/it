<?php /* D:\wamp64\www\ducloi\it\administrator\components\com_admintools\tmpl\ControlPanel\default.blade.php */ ?>
<?php
/**
 * @package   admintools
		...
		<div>
			<?php if($this->isRescueMode): ?>
				<div class="akeeba-block--failure">
					<div>
						<h3><?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_HEAD'); ?></h3>
						<p>
							<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_MESSAGE'); ?>
						</p>
						<p>
							...
							>
								...
								<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_BTN_HOWTOUNBLOCK'); ?>
							</a>
							<a class="akeeba-btn--red"
							   href="index.php?option=com_admintools&view=ControlPanel&task=endRescue"
							>
								<span class="akion-power"></span>
								<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_RESCUEMODE_BTN_ENDRESCUE'); ?>
							</a>
						</p>
					</div>
				</div>
			...
			<div id="selfBlocked" class="text-center" style="display: none;">
				<a class="akeeba-btn--red--big"
				   href="<?php echo $this->container->template->route('index.php?option=com_admintools&view=ControlPanel&task=unblockme'); ?>">
					<span class="akion-unlocked"></span>
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_UNBLOCK_ME'); ?>
				</a>
			</div>
		...
		<div>
			<div class="akeeba-panel--default">
				<header class="akeeba-block-header">
					<h3><?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_LBL_CONTROLPANEL_UPDATES'); ?></h3>
				</header>
				...
				<div>
					...
					<p>
						Copyright &copy; 2010&ndash;<?php echo date('Y'); ?> Nicholas K. Dionysopoulos /
						<a href="https://www.akeeba.com">Akeeba Ltd</a>
					</p>
					<p>
						If you use Admin Tools <?php echo ADMINTOOLS_PRO ? 'Professional' : 'Core'; ?>, please post a rating and
						a review at the <a href="http://extensions.joomla.org/extensions/extension/access-a-security/site-security/admin-tools<?php echo ADMINTOOLS_PRO ? '-professional' : ''; ?>">
				...
				<div id="akeeba-changelog" tabindex="-1" role="dialog" aria-hidden="true" style="display:none;">
					<div class="akeeba-renderer-fef">
						<div class="akeeba-panel--info">
							<header class="akeeba-block-header">
								<h3><?php echo \Joomla\CMS\Language\Text::_('CHANGELOG'); ?></h3>
							</header>
							<div id="DialogBody">
			...
			<div id="disclaimer" class="akeeba-block--info">
				<h3><?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_LBL_CONTROLPANEL_DISCLAIMER'); ?></h3>

				<p>
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_LBL_CONTROLPANEL_DISTEXT'); ?>
				</p>
			</div>
		</div>
	</div>
