<?php /* D:\wamp64\www\ducloi\it\administrator\components\com_admintools\tmpl\ControlPanel\stats.blade.php */ ?>
<?php
/**
 * @package   admintools
...
<div class="akeeba-panel--default">
	<header class="akeeba-block-header">
		<h3><?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS'); ?></h3>
	</header>
		...
		<tr>
			<td width="75%">
				<a href="<?php echo sprintf($logUrl, (gmdate('Y') - 1) . '-01-01 00:00:00', (gmdate('Y') - 1) . '-12-31 23:59:59'); ?>">
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS_LASTYEAR'); ?>
				</a>
			</td>
		...
		<tr>
			<td>
				<a href="<?php echo sprintf($logUrl, gmdate('Y') . '-01-01', gmdate('Y') . '-12-31 23:59:59'); ?>">
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS_THISYEAR'); ?>
				</a>
			</td>
		...
		<tr>
			...
			<td>
				<a href="<?php echo sprintf($logUrl, $y . '-' . $m . '-01', $y . '-' . $m . '-' . $lmday . ' 23:59:59'); ?>">
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS_LASTMONTH'); ?>
				</a>
			</td>
			<td style="text-align:right">
				<?php echo $logsModel->reset()
		...
		<tr>
			...
			<td>
				<a href="<?php echo sprintf($logUrl, gmdate('Y') . '-' . gmdate('m') . '-01', gmdate('Y') . '-' . gmdate('m') . '-' . $lmday . ' 23:59:59'); ?>">
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS_THISMONTH'); ?>
				</a>
			</td>
			<td style="text-align:right">
				<?php echo $logsModel->reset()
		...
		<tr>
			<td width="75%">
				<a href="<?php echo sprintf($logUrl, gmdate('Y-m-d', time() - 7 * 24 * 3600), gmdate('Y-m-d')); ?>">
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS_LAST7DAYS'); ?>
				</a>
			</td>
			<td style="text-align:right" width="25%">
				<?php echo $logsModel->reset()
		...
		<tr>
			...
			<td width="75%">
				<a href="<?php echo sprintf($logUrl, $yesterday, $date->format("Y-m-d")); ?>">
					<?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS_YESTERDAY'); ?>
				</a>
			</td>
			<td style="text-align:right" width="25%">
				<?php echo $logsModel->reset()
		...
		<tr>
			...
			<td width="75%">
				<a href="<?php echo sprintf($logUrl, $date->format("Y-m-d"), $expiry->format("Y-m-d")); ?>">
					<strong><?php echo \Joomla\CMS\Language\Text::_('COM_ADMINTOOLS_CONTROLPANEL_DASHBOARD_STATS_TODAY'); ?></strong>
				</a>
			</td>
			<td style="text-align:right" width="25%">
				<strong>
